...
function HeroNav() {
    ...
    return (
        <div className="relative w-full font-[bitum] overflow-hidden 
            ...
            <div className="absolute inset-0 md:right-0 md:w-1/2 md:h-full hidden md:block pointer-events-none z-0">
                {hoverImg && (
                    <img
                        ref={imgRef}
                        src={hoverImg}
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-center z-10">
                {["BLENDING", "CREATIVE", "VISION", "WITH", "INNOVATIVE THINKING."].map((line, i) => (
                    <h1
                        ...
                        className={`text-2xl sm:text-4xl md:text-5xl font-bold leading-snug sm:leading-tight ${
